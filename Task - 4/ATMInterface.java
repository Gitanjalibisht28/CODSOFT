...
public class ATMInterface {
	public static void main(String[] args) {
		 BankAccount obj = new BankAccount(" User", " XYZ0000");
		 obj.showMenu();
...
class  BankAccount{
	...
	void showMenu() {
		...
		do {
			...
			case 'C':
			/* while the user withdraws money,logic to show the remaining balance available in the account before the withdrawal. */

			System.out.println("------------------------------------");
				System.out.println("Amount available in account");
			...
			case 'E':
				...
				double cdInterest=principal*(Math.pow((1+rate/100),time));
				System.out.println("Compound Interest for fixed Deposit:" +cdInterest);
				break;
